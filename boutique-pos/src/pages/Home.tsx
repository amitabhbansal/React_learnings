const Home = () => {
  return (
    <div className="min-h-[75vh]">
      {/* Hero Section */}
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-purple-900 via-purple-950 to-purple-900 shadow-2xl border-2 border-boutique-secondary">
